...
def test_conductor_task_error_with_auto_retry(celery_app, celery_worker, task_poll_response):
    httpretty.reset()
    httpretty.register_uri(
        httpretty.GET,
        "https://localhost:8080/api/tasks/poll/celery_test_task?workerid=localhost",
...
def test_conductor_task_error_without_auto_retry(celery_app, celery_worker, task_poll_response):
    httpretty.reset()
    httpretty.register_uri(
        httpretty.GET,
        "https://localhost:8080/api/tasks/poll/celery_test_task?workerid=localhost",
