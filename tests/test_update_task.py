...
def test_update_task(celery_app, celery_worker, task_poll_response):
    ...
    payload = {"name": name, "task_id": conductor_task.task_id, "workflow_instance_id":  conductor_task.workflow_instance_id, "worker_id": conductor_task.worker_id, "values": {'total': 8}}
